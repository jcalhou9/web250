 ...
 */
 ...
 $mysqli = new mysqli($serverName = 'xxxxxxxx', $username = 'xxxxxx', $password = 'xxxxx');
  ...
  $query = "DROP DATABASE IF EXISTS if0_38352683_cars";
  echo "<p>***********</p>";
  echo $query ;
  echo "<p>***********</p>";
  if ($mysqli->query($query) === TRUE) 
  {
      echo "Database Dropped</P>";
  }

/* Create table doesn't return a resultset */
if ($mysqli->query("CREATE DATABASE IF NOT EXISTS if0_38352683_cars") === TRUE) {
    echo "<p>Database if0_38352683_cars created</P>";
}

//select a database to work with
$mysqli->select_db("if0_38352683_cars");
   Echo ("Selected the if0_38352683_cars database");
...
$query = "INSERT IGNORE INTO `if0_38352683_cars`.`inventory` 
...
$query = "INSERT IGNORE INTO `if0_38352683_cars`.`inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES 
...
// Insert 27 other if0_38352683_cars
