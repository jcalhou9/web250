...
if ($mysqli->query("CREATE DATABASE if0_38352683_cars") === TRUE) {
    echo "<p>Database if0_38352683_cars created</P>";
}
else
{
    echo "Error creating if0_38352683_cars database: " . mysql_error()."<br>";
}
...
$query = "INSERT INTO `if0_38352683_cars`.`inventory` 
...
$query = "INSERT INTO `if0_38352683_cars`.`inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES 
